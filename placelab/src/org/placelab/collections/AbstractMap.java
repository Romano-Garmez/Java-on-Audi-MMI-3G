...
public abstract class AbstractMap implements Map
{
   ...
   * default implementation simply calls <code>super.pclone()</code>.
   *
   * @return the shallow clone
   * @throws CloneNotSupportedException if a subclass is not Cloneable
   * @see Cloneable
   */
  protected Object pclone() throws CloneNotSupportedException
  {
      AbstractMap copy;
      try {
          copy = (AbstractMap) this.getClass().newInstance();
      } catch (Exception e) {
          throw new CloneNotSupportedException("newInstance failed");
      }
