...
while (i.hasNext())
{
    ...
    return new Iterator()
    {
      ...
      private void checkMod()
      {
        if (knownMod != modCount)
          throw new ConcurrentModificationException("AbstractList.Iterator.checkMod.1");
      }
  ...
  public ListIterator listIterator(final int index)
  {
    ...
    return new ListIterator()
    {
      ...
      {
        if (knownMod != modCount)
          throw new ConcurrentModificationException("AbstractList.ListIterator.checkMod.2");
      }
...
class SubList extends AbstractList
{
  ...
  void checkMod()
  {
    if (modCount != backingList.modCount)
      throw new ConcurrentModificationException("AbstractList.checkMod.3");
  }
