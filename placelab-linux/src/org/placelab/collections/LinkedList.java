  ...
  implements List, Cloneable//, Serializable
{
  ...
  /**
   * Removes the entry at the lowest index in the list that matches the given object.
   * It compares by <code>o == null ? e = null : o.equals(e)</code>.
   *
  ...
  {
    if (a.length < size)
    	throw new ArrayIndexOutOfBoundsException("this array is too small to hold the collection");
  ...
  private final class LinkedListItr implements ListIterator
  {
    ...
    private void checkMod()
    {
      if (knownMod != modCount)
        throw new ConcurrentModificationException("LinkedList.LinkedListItr.checkMod.7");
    }
